...
|----------------------------------------|------------------|-----------------------------------------------------------------------------------------------------------|-----------------------------|----------|
| **SQL**                                | KARPOV.COURSES   | Основы SQL (JOINы, группировка, оконные функции), Расчёт ARPU, ARPPU, AOV с исключением отменённых заказов| PostgreSQL                     | Ссылка |
...
| **Практикум по статичтке на Python**   | Stepik           | Визуализация ключевых показателей продукта: выручка, воронка, сегменты     | Power BI                    | [Ссылка](https://stepik.org/cert/2781738) |
| **Демоверсия курса "Аналитик данных**  | Stepik           | A/B-тесты, отток, парадокс метрик и как жить, когда Retention упал         | Markdown, боль              | Ссылка |
